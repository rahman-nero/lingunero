      ...
      <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl dark:shadow-gray-900/50 p-8 transition-colors">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-5">
          ...
          <div>
            ...
            />
            <p v-if="formErrors.name" class="mt-2 text-sm text-red-600 dark:text-red-400">
              {{ formErrors.name }}
            </p>
          </div>
          ...
          <div>
            ...
            <p v-if="formErrors.password_confirmation" class="mt-2 text-sm text-red-600 dark:text-red-400">
              {{ formErrors.password_confirmation }}
            </p>
          </div>

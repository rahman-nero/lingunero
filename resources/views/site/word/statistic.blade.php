    ...
    <section id="content">
        ...
        <div class="block-statistic">
            ...
            <div class="result">
                ...
                <p class="count-right" data-count="{{ $statistic->first()->count_true }}">Правильные: <span>{{ $statistic->first()->count_true }}</span></p>
            </div>
...
@push('js')
    <script>
        ...
        console.log(countWrong / (countWords / 100))

        const result = countWrong / (countWords / 100);
